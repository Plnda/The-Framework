...
namespace VolumetricFogAndMist2 {
    ...
    public class VolumetricFogManagerEditor : Editor {
        ...
        SerializedProperty downscaling, blurPasses, blurDownscaling, blurSpread, blurHDR, blurEdgePreserve, blurEdgeThreshold;
        ...
        private void OnEnable() {
            ...
            blurEdgeThreshold = serializedObject.FindProperty("blurEdgeThreshold");
            ScanAdvancedOptions();
        }
        ...
        public override void OnInspectorGUI() {
            ...
            if (blurPasses.intValue > 0) {
                ...
                if (blurEdgePreserve.boolValue) {
                    EditorGUILayout.PropertyField(blurEdgeThreshold, new GUIContent("Edge Threshold"));
                }
                EditorGUI.indentLevel--;
            }
